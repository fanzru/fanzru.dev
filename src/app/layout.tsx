  ...
  return (
    <html lang="en" className="dark">
      ...
      >
        ...
        <div
          className="fixed inset-0 z-[-2] bg-[linear-gradient(to_right,#4f4f4f15_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f15_1px,transparent_1px)] bg-[size:64px_64px]"
          style={{
            maskImage:
