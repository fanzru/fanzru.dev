...
const Footer = () => {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/fanzrudev",
      icon: (
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/fanzrudev",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/fanzrudev",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="mt-auto py-12 px-4 sm:px-6 lg:px-8 border-t border-white/10">
        ...
        <section className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <article className="flex-1">
            ...
            <ul className="space-y-3">
              {["Profile", "Projects", "Story", "Blog"].map((item) => (
                <li key={item}>
                  <Link
